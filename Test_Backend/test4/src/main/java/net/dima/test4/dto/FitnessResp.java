...
public class FitnessResp {
	...
	public FitnessResp(int id, String name, String gender, double height, double weight) {
		super(); 	// 상위클래스(Object)를 생성하는 실행문. 
		this.id = id;
		this.name = name;
		this.gender = gender;
		this.height = height;
	...
	// Entity --> FitnessResp
	public static FitnessResp toFitnessResp(FitnessEntity entity) {
		FitnessResp resp = FitnessResp.builder()
				.id(entity.getId())
				.name(entity.getName())
